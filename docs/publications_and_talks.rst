...
論文
========
NVIDIA FLARE に関連する論文・出版物の一覧です (網羅的なものではありません)。
`Clara Train SDK <https://catalog.ngc.nvidia.com/orgs/nvidia/containers/clara-train-sdk>`__ に含まれていた NVIDIA FLARE の前身ライブラリを使用した論文も含みます。
...
ブログと動画
--------------
NVIDIA FLARE に関連するブログやその他のメディアです。
...
講演
------
フェデレーテッドラーニングの研究と NVIDIA FLARE を扱った最近の講演やウェビナーです。
