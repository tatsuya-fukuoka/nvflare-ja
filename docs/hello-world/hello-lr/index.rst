...
| サイト          | サンプル分割                                |
+==============+=======================================+
| Cleveland    | train: 199サンプル, test: 104サンプル         |
+--------------+---------------------------------------+
| Hungary      | train: 172サンプル, test: 89サンプル          |
+--------------+---------------------------------------+
| Switzerland  | train: 30サンプル, test: 16サンプル           |
+--------------+---------------------------------------+
| Long Beach V | train: 85サンプル, test: 45サンプル           |
+--------------+---------------------------------------+
...
| cp            | 特徴量        | カテゴリ        |             |                                                       |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| trestbps      | 特徴量        | 整数          |             | 安静時血圧(入院時)                                            | mm Hg  | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| chol          | 特徴量        | 整数          |             | 血清コレステロール                                             | mg/dl  | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| fbs           | 特徴量        | カテゴリ        |             | 空腹時血糖 > 120 mg/dl                                     |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| restecg       | 特徴量        | カテゴリ        |             |                                                       |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| thalach       | 特徴量        | 整数          |             | 最大心拍数                                                 |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| exang         | 特徴量        | カテゴリ        |             | 運動誘発性狭心症                                              |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| oldpeak       | 特徴量        | 整数          |             | 安静時に対する運動誘発性ST低下                                      |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| slope         | 特徴量        | カテゴリ        |             |                                                       |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| ca            | 特徴量        | 整数          |             | 透視法で着色された主要血管の数(0-3)                                  |        | あり       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| thal          | 特徴量        | カテゴリ        |             |                                                       |        | あり       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
| num           | ターゲット      | 整数          |             | 心疾患の診断                                                |        | なし       |
+---------------+------------+-------------+-------------+-------------------------------------------------------+--------+----------+
